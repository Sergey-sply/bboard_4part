...
from .views import (index, other_page, profile, user_activate, BBLoginView, BBLogoutView, ProfileEditView,
                    PasswordEditView, RegisterView, RegisterDoneView, ProfileDeleteView)
